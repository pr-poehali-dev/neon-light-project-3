    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Аналитика и контроль бюджета</span>
        ...
        >
          Держите бюджет под контролем каждый день
        </h2>

        {/* Description */}
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Видите, куда уходят деньги.</span> Директолог показывает динамику
          расходов, конверсий и CPL по кампаниям — наглядно и в реальном времени.
        </p>
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              >
                ...
                <span className="text-zinc-300 text-sm font-medium">Поиск — Москва и область</span>
                <div
              ...
              >
                ...
                <span className="text-zinc-500 text-sm">РСЯ — Ретаргетинг</span>
              </div>
              ...
              >
                <span className="text-zinc-400 text-sm">Смарт-баннеры</span>
              ...
              >
                <span className="text-zinc-400 text-sm">Брендовый трафик</span>
                <div className="flex gap-0.5">
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Полная сводка по рекламе</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Директолог собирает данные из всех кампаний и показывает главное одним сообщением.
            </p>

            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-200 mb-5">Отчёт за сегодня</h4>
              ...
              {/* Resources row */}
              <div className="flex items-center gap-4 mb-4">
                <span className="text-zinc-500 text-sm w-20">Источники</span>
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-300 text-xs">
                    <span className="text-purple-400">Яндекс.Директ</span>
                  </span>
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-400 text-xs">
                    <span className="text-yellow-500">Яндекс.Метрика</span>
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <span className="text-zinc-500 text-sm w-20 pt-1">Метрики</span>
                <div className="flex flex-col gap-2">
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-green-500" />
                    CTR объявлений <span className="text-zinc-500">+12%</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-purple-500" />
                    Конверсия <span className="text-zinc-500">3.4% из 100</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-400 text-sm">
                    ...
                    CPL <span className="text-zinc-500">↑34% — требует внимания</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-b border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Статус рекламы в реальном времени</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Директолог мгновенно сигнализирует, когда что-то идёт не так с кампанией.
            </p>
            ...
            <div className="relative h-48">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-green-500 font-medium text-sm">Всё в норме</span>
                </div>
                <p className="text-zinc-300 text-sm mb-3">CPL снизился на 18% — кампания работает отлично</p>
                <span className="text-zinc-500 text-xs">сегодня, 09:41</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="border-r border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-200 font-medium">Анализ ключевых слов</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/50" />
                <span className="text-zinc-400">Мониторинг CTR и конверсий</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/30" />
                <span className="text-zinc-500">Автоматические минус-слова</span>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <div className="mb-3 relative inline-block">
                  <span className="text-zinc-200 text-lg font-medium">Поиск — Москва и область:</span>
                  <span className="relative mx-1">
                    <span className="text-zinc-200 text-lg font-medium bg-red-500/20 px-0.5">CPL +34%</span>
                    <span className="absolute -top-4 right-0 px-1.5 py-0.5 rounded text-[10px] bg-red-600 text-white">
                      важно
                    </span>
                  </span>
                </div>
                ...
                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                  За последние 7 дней стоимость лида выросла на 34%.{" "}
                  <span className="relative inline">
                    <span className="bg-yellow-500/20 px-0.5">Причина</span>
                    <span className="absolute -bottom-4 left-0 px-1.5 py-0.5 rounded text-[10px] bg-yellow-600 text-white">
                      анализ
                    </span>
                  </span>
                  {" "}— рост показов по нецелевым фразам. Рекомендуем добавить минус-слова и скорректировать ставки.
                </p>
